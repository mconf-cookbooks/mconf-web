# This is a copy from this version:
# https://github.com/chef/chef/blob/v12.11.26/lib/chef/provider/service/debian.rb
# With a few methods from this one:
# https://github.com/chef/chef/blob/v14.15.6/lib/chef/provider/service/debian.rb
# Had to do this to get it working on Ubuntu 18.04. update-rc.d changed its syntax.
class Chef
  class Provider
    class Service
